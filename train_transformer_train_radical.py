...
parser.add_argument('--data_dir', action='store', type=str,
                    default='data/chembert_data/Reaction_T1/1/', help='data directory.')
...
parser.add_argument('--model_dir', action='store', type=str,
                    default='model/2Reaction_T1_pretrain/1/', help='directory to save model')
...
def eval(test_model, sess, writer, tf_acc, acc_summary, global_step, val_data, max_length, approx_num, code_of_start,
         code_of_end, code_of_pad):
...
if __name__ == '__main__':
    ...
    ### load word2idx
    try:
        with open('/home/tanshui/Desktop/qiaomeng_project/ChemTrm_all/model/word2idx.json', 'r') as ifile:
